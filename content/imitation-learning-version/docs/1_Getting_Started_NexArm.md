...
For Android devices, install the **Wonderbot-V2.3.4.apk** from the [2. Softwares & Source Code\2.1 Software & Tool\NexArm Software\NexArm App Installation Package](https://drive.google.com/drive/folders/1DkTxvA6XXTm4M9j814tUv6zuziMUGDl6?usp=sharing) folder.
...
1. Double-click **ch341ser.exe** in [1. Tutorials/1. Getting Started/04 Appendix/03 Serial Port Driver](https://drive.google.com/drive/folders/1PlN91umi-Bi_yvB81vhOCM9u9wQphPVT?usp=sharing).
...
1. Find **NexArm.exe** in [2. Softwares & Source Code\2.1 Software & Tool\NexArm Software\NexArm PC Software](https://drive.google.com/drive/folders/1tuBPkSpHVMYLhKWt6Q7_whkr-KD650U9?usp=sharing).
...
5. Factory preset action groups are provided under [1. Tutorials/1. Getting Started/04 Appendix/04 Factory Action Groups](https://drive.google.com/drive/folders/1Ro8RtXJMLRjq_NrI7_dNe77jxYSPV9A3?usp=sharing). They can be flashed to NexArm by following the method above.
