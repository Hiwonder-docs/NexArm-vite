# 2. Imitation Learning Tutorial

## 2.1 Introduction to LeRobot
...
## 2.2 Hardware and Environment Setup

### 2.2.1 Hardware Checklist

<img src="../_static/media/chapter_2/section_2/image_43.png" class="common_img" style="width:1000px;"/>

### 2.2.2 Installing Miniconda
...
Locate **Miniconda3-py311_25.7.0-2-Windows-x86_64.exe** and download the package to the computer. Alternatively, the pre-packaged software can be accessed directly via the link: [2. Softwares & Source Code\2.1 Software & Tool\Imitation Learning Software](https://drive.google.com/drive/folders/19wtYtZMfHir9dtMfmXikfSO9pN0W0Hym?usp=sharing).

<img src="../_static/media/chapter_2/section_2/image_1.png" class="common_img" style="width:400px;"/>

② Install **Miniconda**

Locate the downloaded **Miniconda** installation package and double-click to install.

<img src="../_static/media/chapter_2/section_2/image_3.png" class="common_img" style="width:500px;"/>

<img src="../_static/media/chapter_2/section_2/image_4.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_2/image_5.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_2/image_6.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_2/image_7.png" class="common_img" style="width:600px;"/>

> [!NOTE]
>
> **All options below must be selected. Otherwise, environment configuration issues may occur!**

<img src="../_static/media/chapter_2/section_2/image_8.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_2/image_9.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_2/image_10.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_29.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_46.png" class="common_img" style="width:800px;"/>

Press **Enter** to continue.

<img src="../_static/media/chapter_2/section_2/image_47.png" class="common_img" style="width:700px;"/>

Type `yes` and press **Enter** to continue.

<img src="../_static/media/chapter_2/section_2/image_48.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_49.png" class="common_img" style="width:600px;"/>

Type `yes` and press **Enter** to complete the installation.

<img src="../_static/media/chapter_2/section_2/image_50.png" class="common_img" style="width:700px;"/>

Upon closing and reopening the terminal, the interface shown below will appear.

<img src="../_static/media/chapter_2/section_2/image_51.png" class="common_img" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_52.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_53.png" class="common_img" style="width:800px;"/>

### 2.2.3 Configuring the Virtual Environment
...
<img src="../_static/media/chapter_2/section_2/image_11.png" class="common_img" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_38.png" class="common_img" style="width:800px;"/>

When the prompt shown below appears, enter `y` and then press **Enter** to continue.

<img src="../_static/media/chapter_2/section_2/image_16.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_39.png" class="common_img" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_40.png" class="common_img" style="width:400px;"/>

④ Download the Repository

**NexArm** project package path: **[2. Softwares & Source Code\2.2 Source Code\Imitation Learning Project Package\finsh.zip](https://drive.google.com/drive/folders/1MXvVt7WmyRAA_jmOvlQZrytSzC2QkCLo?usp=sharing)**.

Open the **NexArm** project package and extract the project files to the desktop.

<img src="../_static/media/chapter_2/section_2/image_19.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_41.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_56.png" class="common_img" style="width:700px;"/>

When the prompt shown below appears, enter `y` and then press **Enter** to continue.

<img src="../_static/media/chapter_2/section_2/image_22.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_23.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_24.png" class="common_img" style="width:600px;"/>

③ Download the Repository

**NexArm robotic arm** project package path: **[2. Softwares & Source Code\2.2 Source Code\Imitation Learning Project Package\finsh.zip](https://drive.google.com/drive/folders/1MXvVt7WmyRAA_jmOvlQZrytSzC2QkCLo?usp=sharing)**.
...
<img src="../_static/media/chapter_2/section_2/image_25.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_26.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image_27.png" class="common_img" style="width:700px;"/>

## 2.3 Robotic Arm Assembly
...
<img src="../_static/media/chapter_2/section_2/image_54.png" class="common_img" style="width:700px;"/>

2. Connect the leader arm next, repeat the aforementioned procedure, and retrieve the port number of the leader arm.

<img src="../_static/media/chapter_2/section_2/image_55.png" class="common_img" style="width:700px;"/>

### 2.3.4 Servo ID Diagram (Optional)
...
<img src="../_static/media/chapter_2/section_3/image_7.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_4/image_8.png" class="common_img" style="width:700px;"/>

Once execution completes, captured images will be saved to **outputs\captured_images**.

<img src="../_static/media/chapter_2/section_4/image_9.png" class="common_img" style="width:700px;"/>

<img src="../_static/media/chapter_2/section_4/image_10.png" class="common_img" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_4/image_14.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_4/image_12.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_5/image_1.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_5/image_3.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_5/image_4.png" class="common_img" style="width:800px;"/>
...
<img src="../_static/media/chapter_2/section_5/image_6.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_5/image_8.png" class="common_img" style="width:800px;"/>

Data is saved by default to **C:\Users\{name}\.cache\huggingface\lerobot**.

<img src="../_static/media/chapter_2/section_5/image_9.png" class="common_img" style="width:600px;"/>

## 2.6 Dataset Training

### 2.6.1 Local Training

Datasets are saved by default to **C:\Users\Admin\\.cache\huggingface\lerobot**.

<img src="../_static/media/chapter_2/section_6/image_40.png" class="common_img" style="width:800px;"/>

Press **Win + X** and click **Terminal (Admin)** to open the command-line terminal with administrative privileges.

<img src="../_static/media/chapter_2/section_6/image_41.png" class="common_img" style="width:200px;"/>
...
<img src="../_static/media/chapter_2/section_6/image_43.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_6/image_42.png" class="common_img" style="width:1200px;"/>
...
<img src="../_static/media/chapter_2/section_6/image_31.png" class="common_img" style="width:1200px;"/>

Upon completion of the training, a **train** folder containing the model files will be generated in **finsh/outputs**.

<img src="../_static/media/chapter_2/section_6/image_44.png" class="common_img" style="width:600px;"/>
...
### 2.7.1 Real-Time Inference Testing

Press **Win + R**, type `cmd`, and open the terminal.

<img src="../_static/media/chapter_2/section_7/image_6.png" class="common_img" style="width:400px;"/>
...
<img src="../_static/media/chapter_2/section_7/image_1.png" class="common_img" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_7/image_7.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_7/image_3.png" class="common_img" style="width:700px;"/>

The terminal log shown below indicates the completion of robotic arm inference.

<img src="../_static/media/chapter_2/section_7/image_4.png" class="common_img" style="width:900px;"/>

### 2.7.2 Inference Troubleshooting

**Issue 1: Error Occurs During the Second Inference Run**

<img src="../_static/media/chapter_2/section_7/image_8.png" class="common_img" style="width:900px;"/>
