# 16. NexArm + Mecanum-Wheel Chassis Course

## 16.1 Preparation

### 16.1.1 Chassis Installation

For detailed mechanical installation of the robotic arm and chassis, refer to [16. NexArm + Mecanum-Wheel Chassis Course/NexArm Suspension Mecanum-Wheel Chassis Installation Tutorial](https://youtu.be/JPNck10q2l8).

### 16.1.2 Wiring Instructions

Connect the four motors of the Mecanum-wheel chassis in sequence: **M1** for the front-left wheel, **M2** for the rear-left wheel, **M3** for the front-right wheel, and **M4** for the rear-right wheel. Connect the 4-channel motor encoder driver module to I2C port **2** on the expansion board using a 4-pin cable. Then connect the 4-channel motor encoder driver module to 3-pin port **1** on the STM32 expansion board using a 3-pin cable.

<img class="common_img" src="../_static/media/chapter_18/section_1/media/image1.png" style="width:800px;" />

For detailed wiring instructions and hardware connections of the robotic arm and chassis, refer to [16. NexArm + Mecanum-Wheel Chassis Course/NexArm Mecanum-Wheel Chassis Wiring Tutorial](https://drive.google.com/drive/folders/16VxMwYdGh5WnNzxCjcmRqczbPbIrE0xf?usp=sharing).

## 16.2 Machine Type Selection
...
2. Double-click the model configuration tool icon <img class="inline-icon" src="../_static/media/chapter_18/section_2/media/image1.png" style="width:30px;" /> on the desktop to open the utility.

3. Select the appropriate options according to the robotic arm version, camera version, and accessory type:

   <img class="common_img" src="../_static/media/chapter_18/section_2/media/image2.png" style="width:800px;" />

   <img class="common_img" src="../_static/media/chapter_18/section_2/media/image3.png" style="width:800px;" />
...
4. After selection, click **Save** to save the configuration.
   ...
   <img class="common_img" src="../_static/media/chapter_18/section_2/media/image4.png" style="width:400px;" />

5. Click **Apply** to reload the configuration.

   <img class="common_img" src="../_static/media/chapter_18/section_2/media/image5.png" style="width:400px;" />

   Wait for the buzzer to emit a single beep, indicating that the reboot is complete and the configuration has taken effect.

## 16.3 App Control

### 16.3.1 App Installation
...
<img class="common_img" src="../_static/media/chapter_18/section_3/media/image1.png" style="width:400px;" />

### 16.3.2 Connection Mode Introduction
...
Tap **Robot Control** <img class="inline-icon" src="../_static/media/chapter_1/section_4/media/image33.png" style="width:60px;" /> to enter the control interface.

<img class="common_img" src="../_static/media/chapter_18/section_3/media/image2.png" style="width:800px;" />

| Feature | Icon | Function Description |
| :--- | :---: | :--- |
| Video feedback screen | <img src="../_static/media/chapter_18/section_3/media/image3.png" style="width:200px;" /> | Controls pan-tilt rotation to the right, gripper rotation to the right, pan-tilt rotation to the left, and gripper rotation to the left. |
| Chassis control | <img src="../_static/media/chapter_18/section_3/media/image4.png" style="width:200px;" /> | Controls chassis forward, backward, left translation, and right translation movement. |
| Speed adjustment slider | <img src="../_static/media/chapter_18/section_3/media/image5.png" style="width:200px;" /> | Adjusts chassis travel speed. |
| Steering control | <img src="../_static/media/chapter_18/section_3/media/image6.png" style="width:200px;" /> | Controls chassis turning left and right. |
| Reset button | <img src="../_static/media/chapter_18/section_3/media/image7.png" style="width:200px;" /> | Controls the robotic arm to return to the initial posture. |
| Robotic arm control | <img src="../_static/media/chapter_18/section_3/media/image8.png" style="width:200px;" /> | Individually controls rotation of each corresponding servo on the robotic arm. |

## 16.4 Wireless Controller Remote Control

### 16.4.1 PS3 Wireless Controller Introduction
...
### 16.4.4 Wireless Controller Key Descriptions
...
### 16.5.1 Implementation Workflow
...
### 16.5.2 Application Operating Steps

1. Power on the robotic arm and connect it to the remote desktop software **VNC**. For details on remote desktop tool installation and connection, refer to [1. Tutorials/1. NexArm User Manual/1.5 Development Environment Setup and Configuration](https://wiki.hiwonder.com/projects/NexArm/en/ros-version/docs/1.%20NexArm%20User%20Manual.html#_1-5-development-environment-setup-and-configuration).

2. Click the icon <img class="inline-icon" src="../_static/media/chapter_18/section_5/media/image1.png" style="width:30px;" /> to open the command-line terminal.
...
5. Once the application starts, the terminal prints the prompt information shown below, and the camera video feedback window pops up automatically:
   ...
   <img class="common_img" src="../_static/media/chapter_18/section_5/media/image2.png" style="width:800px;" />
...
6. Click the target object to track in the video feed using the mouse. The program automatically detects the color threshold and configures it as the target object:
   ...
   <img class="common_img" src="../_static/media/chapter_18/section_5/media/image3.png" style="width:800px;" />

7. After selection, open a new terminal <img class="inline-icon" src="../_static/media/chapter_18/section_5/media/image4.png" style="width:30px;" />, and enter the following command to start tracking:
...
### 16.6.1 Implementation Workflow
...
### 16.6.2 Application Operating Steps

1. Power on the robotic arm and connect it to the remote desktop software **VNC**. For details on remote desktop tool installation and connection, refer to [1. Tutorials/1. NexArm User Manual/1.5 Development Environment Setup and Configuration](https://wiki.hiwonder.com/projects/NexArm/en/ros-version/docs/1.%20NexArm%20User%20Manual.html#_1-5-development-environment-setup-and-configuration).

2. Click the icon <img class="inline-icon" src="../_static/media/chapter_18/section_6/media/image1.png" style="width:30px;" /> to open the command-line terminal.
...
5. Once the application starts, the terminal prints prompt information, and the camera video feedback window opens automatically:
   ...
   <img class="common_img" src="../_static/media/chapter_18/section_6/media/image2.png" style="width:800px;" />
...
6. Click the line to follow in the camera view using the mouse. The program automatically evaluates color thresholds and designates it as the target trajectory:
   ...
   <img class="common_img" src="../_static/media/chapter_18/section_6/media/image3.png" style="width:800px;" />

7. After selection, open a new terminal <img class="inline-icon" src="../_static/media/chapter_18/section_6/media/image4.png" style="width:30px;" />, and enter the following command to initiate line following:
