...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.3pxatJAg.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
function getVersionBase(version = defaultVersion) {
  return `/projects/${projectName}/en/${version}/`;
}
function getVersionDefinition(version) {
...
function getVersionEntryPath(version = defaultVersion) {
  var _a;
  return ((_a = getVersionDefinition(version)) == null ? void 0 : _a.entryPath) || "/docs/";
}
function getVersionUrl(version = defaultVersion, path = "") {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const VERSION_LABELS = getVersionLabels();
